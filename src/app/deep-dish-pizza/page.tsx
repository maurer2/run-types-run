    ...
    <article className="container max-w-4xl mx-auto px-8 py-8">
      <div className="mockup-window border border-base-300">
        <div className="px-4 py-16 bg-base-200">
          <h1 className="mb-4 text-2xl">Deep Dish Pizza (Fake click event handling in server components)</h1>
          {/* https://www.robinwieruch.de/react-form-button/#react-form-button-in-a-server-component */}
